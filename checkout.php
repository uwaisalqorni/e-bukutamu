...
// Update waktu_keluar untuk record terakhir tamu dengan NIK ini yang belum Check-Out
...
if ($conn->query($sql) === TRUE) {
    if ($conn->affected_rows > 0) {
        ...
        echo "<script>alert('⚠️ Data tidak ditemukan atau sudah Check-Out!'); window.location='index.php?id_lokasi=$id_lokasi';</script>";
    }
} else {
